...
public class AddArtistActivity extends AppCompatActivity implements DatePickerDialog.OnDateSetListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Recibir los datos de otra actividad, en este caso MainActivity. -- solo era para probar.
    ...
    private void configActionBar() {
        ...
        if (actionBar != null) {
            actionBar.setDisplayHomeAsUpEnabled(true); /*Habilitar la flecha de regreso en la parte de arriba, solo en vista (falta el codigo) */
        }
    }
    ...
    private void showAddPhotoDialog() {
        //Vamos  a crear un vista sencillo con codigo JAVA, no con XMl como veniamos haciendo.
